...
FILTERED_DOCUMENT_TYPES_PAGE_SIZE = 20
FILTERED_DOCUMENT_TYPES_MAX_PAGES = 5
    ...
    with httpx.Client(base_url=_base_url(settings), timeout=120.0) as client:
        ...
        try:
            document_types = _get_document_types(
                ...
                include_systems=not is_filtered,
                page_size=FILTERED_DOCUMENT_TYPES_PAGE_SIZE
                if is_filtered
                else DOCUMENT_TYPES_PAGE_SIZE,
    ...
    *,
    ...
    while True:
        try:
            ...
            if return_partial_on_timeout and error.status_code == 0:
